...
data = np.genfromtxt("../Data/StandardEM_Opt_4_state_space_merged_10kev_gold_gamma.csv",delimiter=",")
...
plt.ylabel('Count')
plt.title('<10keV Zoom [1000, 1MeV Photons]')
...
#plt.xlabel('Energy (eV)')
plt.ylabel('Count')
plt.title('[1000, 1MeV Photons]')
##
### 10 MeV
##

data = np.genfromtxt("../Data/StandardEM_Opt_4_state_space_merged_100kev_gold_gamma.csv",delimiter=",")
...
plt.xlabel('Energy (eV)')
plt.ylabel('Count')
plt.title('<10keV Zoom [1000, 10MeV Photons]')
